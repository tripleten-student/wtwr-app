 ...
 */
const CreateClothingConfirmationModal = ({ isOpen, onClose, createdClothingItemUrl, createdClothingItemType }) => {
  ...
  return (
    ...
    >
      <div className="confirmation">
        <p className="confirmation__text">{`Your ${handleHyphenatedWords(createdClothingItemType)} has been added to your collection of clothes!`}</p>
        <p className="confirmation__text">You can find it in your profile. It will also be shown in outfits suggestions once it fits the weather forecast.</p>
        <img src={createdClothingItemUrl} alt={createdClothingItemType} className="confirmation__image-preview" />
